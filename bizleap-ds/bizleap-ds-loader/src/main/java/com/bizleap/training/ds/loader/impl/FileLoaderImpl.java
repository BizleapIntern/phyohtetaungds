...
import com.bizleap.common.domain.util.BizleapUtils;
import com.bizleap.common.domain.util.Printer;
...
//	ConfigurationService configurationService;
	...
	private BufferedReader getBufferedReader(String fileName, String encodingType) throws IOException {
		...
		return new BufferedReader(new InputStreamReader(new FileInputStream(BizleapUtils.makePath(dataDir, fileName)), encodingType));
	...
	public void start(String fileName, String encodingType) throws IOException {
		...
		try {
			...
			//bufferedReader = new BufferedReader(new FileReader(configurationService.makeResourcePath(ResourceType.IMPORT, "empty.txt")));
		}
		lineNumber = 0;
		if (errorMap == null)
